...
#$ -o ~/logs/$JOB_NAME_$TASK_ID.outerr
# If you prefer splitting out and error
# -o ~/logs/$JOB_NAME_$TASK_ID.out

# Specify the error file
#$ -e ~/logs/$JOB_NAME_$TASK_ID.outerr
# If perfer splitting
# -e ~/logs/$JOB_NAME_$TASK_ID.err
...
echo "Setting: For input $INPUTFILENAME, clean into $FILENAME_CLEANED"

# Name the project subdirectory
PROJECT_SUBDIR="lpa-analysis"
# Specify working directory under the /tempdata
WORKING_DIR="$PROJECT_SUBDIR/tempdata/$PROJECT_SUBDIR-$SGE_TASK_ID"
echo "Setting: The working directory is $WORKING_DIR"
