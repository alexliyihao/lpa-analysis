...
class METALToolkit:
    ...
    def dataframe_to_metal(self, df):
        ...
        Returns:
            pandas.DataFrame, a tidied version of association table
    ...
    def formatting_final_result(self, df,
                                multi_line_header: bool = False,
                                rename: bool = False):
    ...
    def _save_double_column_df(self, df, xl_writer, start_row=0, **kwargs):
        ...
        # start_row - row from which dataframe will begin
